...
<main id="viernulvier">
  <div class="content">
    <h1>Oeps... De pagina die je zocht is niet gevonden!</h1>
    <a href="/">Keer terug naar de homepage</a>
  </div>

  <div id="page">
  	<div id="container">
        <!-- Made by Carpov - http://cssdeck.com/labs/dancing-robot-with-reflection -->
